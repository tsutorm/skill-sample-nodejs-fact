...
// initialize i18n
var textResources = require("../resources.js");
alexaTest.initializeI18N(textResources);

var supportedLocales = ["en-US", "en-GB", "de-DE", "ja-JP"];
			...
			alexaTest.test([
				{
					...
					says: alexaTest.t("HELP_MESSAGE"), shouldEndSession: false, reprompts: alexaTest.t("HELP_REPROMPT")
				},
				{
					request: alexaTest.getIntentRequest("GetNewFactIntent"),
					saysCallback: assertIfNotFact, shouldEndSession: true, repromptsNothing: true
